    ...
    <div className="about-page">
      <div className="page-header">
        <div className="container">
          <h1>About BREED NET</h1>
          <p>AI-powered cattle breed recognition System</p>
        </div>
      </div>
          ...
          <section className="mission-section">
            <div className="mission-content">
              <div className="mission-text">
                <h2>Our Mission</h2>
                <p>
                  BREED NET is designed to support the Government of India
                ...
                <p>
                  ...
                  identifying diverse Indian cattle and buffalo breeds. Our System serves as a reliable decision-support tool, ensuring consistent and accurate 
          ...
          <section className="technology-section">
            ...
            <div className="tech-grid">
              ...
              <div className="tech-item">
                ...
                <p>Seamless integration with cloud services for real-time updates and data storage</p>
              </div>
              <div className="tech-item">
                <div className="tech-icon">🔒</div>
                <h3>Data Security</h3>
