        ...
        <div className="container">
          <div className="contact-grid">
            ...
            <div className="contact-info">
              <h2>Get in Touch</h2>
              <p>
                Have questions about BREED NET or need support with breed identification? 
              ...
              <div className="contact-details">
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-text">
                    <h4>Phone</h4>
                    <p>+91 0000000000<br />Mon - Fri: 9:00 AM - 6:00 PM</p>
                  </div>
                </div>
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-text">
                    <h4>Email</h4>
                    <p>Akshay12345singh07@gmail.com<br />support@gmail.com</p>
                  </div>
                </div>
          ...
          <section className="faq-section">
            ...
            <div className="faq-grid">
              ...
              <div className="faq-item">
                ...
                <p>Yes, BREED NET is designed to seamlessly integrate with the BPA platform for real-time breed validation.</p>
              </div>
            </div>
          </section>
        </div>
